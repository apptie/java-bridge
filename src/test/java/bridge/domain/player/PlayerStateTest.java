...
class PlayerStateTest {
    ...
    class DescribeIsSuccessfulMethodTest {

        @Nested
        @DisplayName("만약 다리의 마지막 칸의 위치가 주어지면")
        class ContextWithBridgeTest {
            ...
            void it_return_successful(int playerPosition, boolean expected) {
                ...
                boolean actual = playerState.isSuccessful(3);
    ...
    class DescribeFindPlayerPositionTileMethodTest {
